package com.pineapple.kafka.infraestructure.configuration;
...
public class SpringConfiguration {
  ...
  @Bean
  public SendMessageUseCase sendMessageUseCase(MessageDataProvider messageDataProvider) {
    return new SendMessageUseCase(messageDataProvider);
  }

  @Bean
  public ProducerFactory<String, String> producerFactory(
      final @Value("${kafka.bootstrap-servers}") String bootstrapAddress) {
